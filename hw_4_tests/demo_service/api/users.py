...
from hw_4_tests.demo_service.api.contracts import (
    RegisterUserRequest,
    UserResponse,
)
from hw_4_tests.demo_service.api.utils import (
    AdminDep,
    AuthorDep,
    UserServiceDep,
)
from hw_4_tests.demo_service.core.users import UserInfo, UserRole
